...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="pt-32 pb-24 md:pt-40 md:pb-32 bg-gradient-to-br from-primary-50 to-white"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-12">
            ...
            >
              Hello, I'm <span className="text-primary">Abhishek Kumar Singh</span>
            </motion.h1>
            <motion.h2
            ...
            >
              <a
                ...
                className="bg-primary hover:bg-primary-700 text-white font-medium py-3 px-6 rounded-md transition duration-300"
              >
                Get In Touch
              </a>
              <a
                ...
                className="bg-white hover:bg-gray-100 text-primary font-medium py-3 px-6 rounded-md border border-primary transition duration-300"
              >
                View Projects
              </a>
              <a
                ...
                download
                className="flex items-center gap-2 bg-white hover:bg-gray-100 text-gray-700 font-medium py-3 px-6 rounded-md border border-gray-300 transition duration-300"
              >
          ...
          >
            <div className="relative max-w-md mx-auto">
              ...
              <div className="absolute -bottom-4 -right-4 bg-secondary-500 text-white p-4 rounded-full shadow-lg">
