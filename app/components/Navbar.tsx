          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {mounted && (
              <motion.button
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 transition-colors duration-200 relative overflow-hidden"
              ...
              >
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <i className="fas fa-moon text-lg text-blue-400"></i>
                </motion.div>
