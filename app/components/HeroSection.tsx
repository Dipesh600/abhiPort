        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            <div className="relative max-w-md mx-auto">
              ...
              <div className="absolute -bottom-4 -right-4 bg-gradient-to-br from-secondary-400 to-secondary-600 dark:from-secondary-500 dark:to-secondary-700 text-white p-4 rounded-full shadow-lg transform hover:scale-110 transition-transform duration-300">
